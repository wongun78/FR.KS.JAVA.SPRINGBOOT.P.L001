...
public record ExamSubmissionRequestDTO(
    ...
    @Schema(description = "ID of user taking the exam", example = "123e4567-e89b-12d3-a456-426614174000", required = true)
    @NotNull(message = "User ID is required")
    UUID userId,
    
    @Schema(description = "ID of quiz being taken", example = "987fcdeb-51a2-43d7-b456-426614174111", required = true)
    @NotNull(message = "Quiz ID is required")
    UUID quizId,
    
    @Schema(description = "List of question-answer pairs (at least 1 answer required)", required = true)
    ...
    public record QuestionAnswerDTO(
        ...
        @Schema(description = "Question ID", example = "111e4567-e89b-12d3-a456-426614174222", required = true)
        @NotNull(message = "Question ID is required")
        UUID questionId,
        
        @Schema(description = "List of selected answer IDs. For SINGLE_CHOICE: 1 answer. For MULTIPLE_CHOICE: 1+ answers", 
                example = "[\"222e4567-e89b-12d3-a456-426614174333\"]", required = true)
